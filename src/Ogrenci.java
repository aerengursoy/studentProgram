public class Ogrenci {
    ...
    public Ogrenci(String ogrNo, String bolum){
        this.ogrNo = ogrNo;
        this.girisYili = 2020;
        if (bolum.equals("Ceng") || bolum.equals("Bilgisayar Müh")) this.bolumKodu = 201;
        if (bolum.equals("EEE")|| bolum.equals("Elektrik-Elektronik Müh")) this.bolumKodu = 101;
        if (bolum.equals("Me") || bolum.equals("Makine Müh")) this.bolumKodu = 306;
    }
